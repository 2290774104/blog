import{_ as e,o as n,c as s,d as a}from"./app-6240afb3.js";const i={},d=a(`<h1 id="nestjs-安装" tabindex="-1"><a class="header-anchor" href="#nestjs-安装" aria-hidden="true">#</a> nestjs 安装</h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p>Nest 是一个用于构建高效，可扩展的 Node.js 服务器端应用程序的框架。它使用渐进式 JavaScript，内置并完全支持 TypeScript</p><h2 id="安装脚手架" tabindex="-1"><a class="header-anchor" href="#安装脚手架" aria-hidden="true">#</a> 安装脚手架</h2><p>通过 npm 指令全局安装脚手架工具<code>@nestjs/cli</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-g</span> @nestjs/cli
