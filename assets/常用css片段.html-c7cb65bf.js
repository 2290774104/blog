import{_ as n,V as s,W as a,Z as e}from"./framework-91fce522.js";const t={},p=e(`<h1 id="常用css片段" tabindex="-1"><a class="header-anchor" href="#常用css片段" aria-hidden="true">#</a> 常用css片段</h1><h2 id="_1-样式初始化" tabindex="-1"><a class="header-anchor" href="#_1-样式初始化" aria-hidden="true">#</a> 1. 样式初始化</h2><p>目的：</p><ol><li>消除不同浏览器对html文本呈现的差异</li><li>清除标签默认样式</li></ol><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">body </span><span class="token punctuation">{</span>
