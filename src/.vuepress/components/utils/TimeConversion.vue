  ...
  <div>
    <el-form :model="form" label-width="auto">
      <el-row>
        ...
        ></el-col>
        <el-col :span="12">
          <el-button type="primary" @click="handleConversion(form.input1)"
            >转换</el-button
          >
        </el-col>
        <el-col :span="12">
        ...
        ></el-col>
        <el-col :span="12">
          <el-button type="primary" @click="handleConversion(form.input2)"
            >转换</el-button
          >
        </el-col>
      </el-row>
